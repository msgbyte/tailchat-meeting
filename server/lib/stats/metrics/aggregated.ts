...
export default function (workers, rooms_, peers_, config) {
        ...
        for (const consumer of worker.appData.consumers.values()) {
          ...
          for (const s of stats) {
            ...
            if (s.kind === 'video') {
              ...
              spatialLayersOut.push(
                consumer.currentLayers ? consumer.currentLayers.spatialLayer : 0
              );
              temporalLayersOut.push(
                consumer.currentLayers
                  ? consumer.currentLayers.temporalLayer
                  : 0
              );
            } else if (s.kind === 'audio') {
  ...
  [
    ...
    {
      name: 'audio_in_count',
      statName: 'audioBitratesIn',
      statValue: 'length',
    },
    // audio in bitrates
    {
      name: 'audio_bitrates_in_sum',
      statName: 'audioBitratesIn',
      statValue: 'sum',
    },
    {
      name: 'audio_bitrates_in_mean',
      statName: 'audioBitratesIn',
      statValue: 'mean',
    },
    {
      name: 'audio_bitrates_in_min',
      statName: 'audioBitratesIn',
      statValue: 'min',
    },
    {
      name: 'audio_bitrates_in_max',
      statName: 'audioBitratesIn',
      statValue: 'max',
    },
    {
      name: 'audio_bitrates_in_p25',
      statName: 'audioBitratesIn',
      statValue: 'p25',
    },
    // audio in scores
    {
      name: 'audio_scores_in_mean',
      statName: 'audioScoresIn',
      statValue: 'mean',
    },
    {
      name: 'audio_scores_in_min',
      statName: 'audioScoresIn',
      statValue: 'min',
    },
    {
      name: 'audio_scores_in_max',
      statName: 'audioScoresIn',
      statValue: 'max',
    },
    {
      name: 'audio_scores_in_p25',
      statName: 'audioScoresIn',
      statValue: 'p25',
    },
    // video in
    ...
    {
      name: 'video_bitrates_in_mean',
      statName: 'videoBitratesIn',
      statValue: 'mean',
    },
    {
      name: 'video_bitrates_in_min',
      statName: 'videoBitratesIn',
      statValue: 'min',
    },
    {
      name: 'video_bitrates_in_max',
      statName: 'videoBitratesIn',
      statValue: 'max',
    },
    {
      name: 'video_bitrates_in_p25',
      statName: 'videoBitratesIn',
      statValue: 'p25',
    },
    // video in scores
    {
      name: 'video_scores_in_mean',
      statName: 'videoScoresIn',
      statValue: 'mean',
    },
    {
      name: 'video_scores_in_min',
      statName: 'videoScoresIn',
      statValue: 'min',
    },
    {
      name: 'video_scores_in_max',
      statName: 'videoScoresIn',
      statValue: 'max',
    },
    {
      name: 'video_scores_in_p25',
      statName: 'videoScoresIn',
      statValue: 'p25',
    },
    // packets in
    {
      name: 'packets_counts_in_sum',
      statName: 'packetsCountsIn',
      statValue: 'sum',
    },
    {
      name: 'packets_counts_in_mean',
      statName: 'packetsCountsIn',
      statValue: 'mean',
    },
    {
      name: 'packets_counts_in_min',
      statName: 'packetsCountsIn',
      statValue: 'min',
    },
    {
      name: 'packets_counts_in_max',
      statName: 'packetsCountsIn',
      statValue: 'max',
    },
    {
      name: 'packets_counts_in_p25',
      statName: 'packetsCountsIn',
      statValue: 'p25',
    },
    {
      name: 'packets_losts_in_sum',
      statName: 'packetsLostsIn',
      statValue: 'sum',
    },
    {
      name: 'packets_losts_in_mean',
      statName: 'packetsLostsIn',
      statValue: 'mean',
    },
    {
      name: 'packets_losts_in_min',
      statName: 'packetsLostsIn',
      statValue: 'min',
    },
    {
      name: 'packets_losts_in_max',
      statName: 'packetsLostsIn',
      statValue: 'max',
    },
    {
      name: 'packets_losts_in_p25',
      statName: 'packetsLostsIn',
      statValue: 'p25',
    },
    {
      name: 'packets_retransmitted_in_sum',
      statName: 'packetsRetransmittedIn',
      statValue: 'sum',
    },
    {
      name: 'packets_retransmitted_in_mean',
      statName: 'packetsRetransmittedIn',
      statValue: 'mean',
    },
    {
      name: 'packets_retransmitted_in_min',
      statName: 'packetsRetransmittedIn',
      statValue: 'min',
    },
    {
      name: 'packets_retransmitted_in_max',
      statName: 'packetsRetransmittedIn',
      statValue: 'max',
    },
    {
      name: 'packets_retransmitted_in_p25',
      statName: 'packetsRetransmittedIn',
      statValue: 'p25',
    },
    // audio out
    {
      name: 'audio_out_count',
      statName: 'audioBitratesOut',
      statValue: 'length',
    },
    {
      name: 'audio_bitrates_out_sum',
      statName: 'audioBitratesOut',
      statValue: 'sum',
    },
    {
      name: 'audio_bitrates_out_mean',
      statName: 'audioBitratesOut',
      statValue: 'mean',
    },
    {
      name: 'audio_bitrates_out_min',
      statName: 'audioBitratesOut',
      statValue: 'min',
    },
    {
      name: 'audio_bitrates_out_max',
      statName: 'audioBitratesOut',
      statValue: 'max',
    },
    {
      name: 'audio_bitrates_out_p25',
      statName: 'audioBitratesOut',
      statValue: 'p25',
    },
    // video out
    {
      name: 'video_out_count',
      statName: 'videoBitratesOut',
      statValue: 'length',
    },
    {
    ...
    {
      name: 'video_bitrates_out_mean',
      statName: 'videoBitratesOut',
      statValue: 'mean',
    },
    {
      name: 'video_bitrates_out_min',
      statName: 'videoBitratesOut',
      statValue: 'min',
    },
    {
      name: 'video_bitrates_out_max',
      statName: 'videoBitratesOut',
      statValue: 'max',
    },
    {
      name: 'video_bitrates_out_p25',
      statName: 'videoBitratesOut',
      statValue: 'p25',
    },
    // sl
    {
      name: 'spatial_layers_out_mean',
      statName: 'spatialLayersOut',
      statValue: 'mean',
    },
    {
      name: 'spatial_layers_out_min',
      statName: 'spatialLayersOut',
      statValue: 'min',
    },
    {
      name: 'spatial_layers_out_max',
      statName: 'spatialLayersOut',
      statValue: 'max',
    },
    {
      name: 'spatial_layers_out_p25',
      statName: 'spatialLayersOut',
      statValue: 'p25',
    },
    // tl
    {
      name: 'temporal_layers_out_mean',
      statName: 'temporalLayersOut',
      statValue: 'mean',
    },
    {
      name: 'temporal_layers_out_min',
      statName: 'temporalLayersOut',
      statValue: 'min',
    },
    {
      name: 'temporal_layers_out_max',
      statName: 'temporalLayersOut',
      statValue: 'max',
    },
    {
      name: 'temporal_layers_out_p25',
      statName: 'temporalLayersOut',
      statValue: 'p25',
    },
    // rtt out
    {
      name: 'round_trip_times_out_mean',
      statName: 'roundTripTimesOut',
      statValue: 'mean',
    },
    {
      name: 'round_trip_times_out_min',
      statName: 'roundTripTimesOut',
      statValue: 'min',
    },
    {
      name: 'round_trip_times_out_max',
      statName: 'roundTripTimesOut',
      statValue: 'max',
    },
    {
      name: 'round_trip_times_out_p25',
      statName: 'roundTripTimesOut',
      statValue: 'p25',
    },
    ...
    new promClient.Gauge({
      ...
      async collect() {
        await collectStats();
        if (
          mediasoupStats[statName] !== undefined &&
