 ...
 * 幻灯片视图
 */
class Filmstrip extends React.PureComponent<FilmstripProps, FilmstripState> {
  resizeTimeout = null;

  rootContainer = React.createRef<HTMLDivElement>();

  activePeerContainer = React.createRef<HTMLDivElement>();

  filmStripContainer = React.createRef<HTMLDivElement>();
        ...
        <div className={classes.filmStrip} ref={this.filmStripContainer}>
          <Grid container justifyContent="center" spacing={1}>
            <Grid item>
              ...
              >
                {!hideSelfView && (
                  <Me advancedMode={advancedMode} style={peerStyle} />
                )}
              </div>
            </Grid>
