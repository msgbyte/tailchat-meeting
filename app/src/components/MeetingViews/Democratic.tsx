 ...
 * 民主视图
 */
class Democratic extends React.PureComponent<DemocraticProps> {
  state = {
    peerWidth: 0,
    peerHeight: 0,
  };
  ...
  peersRef = React.createRef<HTMLDivElement>();
...
})(withStyles(styles as any, { withTheme: true })(Democratic));
