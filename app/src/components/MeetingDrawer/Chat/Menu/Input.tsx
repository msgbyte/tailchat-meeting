...
const ChatInput = (props) => {
  ...
  useEffect(() => {
    setMessage(
      stateToHTML(editorState.getCurrentContent(), { defaultBlockTag: null })
    );
  }, [editorState]);
        ...
        >
          ...
          <div className={classes.input}>
            <Editor
              ...
              handleKeyCommand={
                browser.platform !== 'mobile' ? handleKeyCommand : null
              }
            ...
            <Grid item>
              ...
              >
                <IconButton
                  ...
                  color={handleInlineStyled('BOLD') ? 'primary' : undefined}
                  component="span"
              ...
              >
                <IconButton
                  ...
                  color={handleInlineStyled('ITALIC') ? 'primary' : undefined}
                  component="span"
              ...
              >
                <IconButton
                  ...
                  color={
                    handleInlineStyled('UNDERLINE') ? 'primary' : undefined
                  }
                  component="span"
              ...
              <React.Fragment>
                ...
                >
                  <IconButton
                    ...
                    classes={{ sizeSmall: classes.icon }}
                    disabled={
                      !canShareFiles || !canShare || chatItemsLength === 0
                    }
                    aria-label={intl.formatMessage({
                      id: 'label.saveChat',
                      defaultMessage: 'Save Chat',
              ...
              <label htmlFor="contained-button-file">
                ...
                >
                  <IconButton
                    ...
                    onMouseDown={(e) => e.preventDefault()}
                  >
                    <AttachFileIcon fontSize={'small'} component={'svg'} />
                  </IconButton>
                </Tooltip>
              </label>
            </React.Fragment>
...
export default withRoomContext(
  ...
  })(withStyles(styles as any)(ChatInput))
);
