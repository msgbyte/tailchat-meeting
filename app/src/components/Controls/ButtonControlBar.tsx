    ...
    >
      <Tooltip title={micTip} placement={smallScreen ? 'top' : 'right'}>
        <Fab
          ...
          disabled={!me.canSendMic || !hasAudioPermission || me.audioInProgress}
          color={
            micState === 'on'
            ...
            micState === 'on' ? (
              <React.Fragment>
                ...
                <SettingsVoiceIcon
                  ...
                  color={me.isAutoMuted ? 'primary' : 'primary'}
                />
              </React.Fragment>
            ) : (
              <MicOffIcon />
      ...
      <Tooltip title={webcamTip} placement={smallScreen ? 'top' : 'right'}>
        <Fab
          ...
          className={classes.fab}
          disabled={
            !me.canSendWebcam || !hasVideoPermission || me.webcamInProgress
          }
...
export default withRoomContext(
  ...
  })(withStyles(styles as any, { withTheme: true })(ButtonControlBar))
);
